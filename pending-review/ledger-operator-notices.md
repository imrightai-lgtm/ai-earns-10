...
| # | Кому | Статус | Детали |
|---|---|---|---|
| 1 | **AI Digest** | ✅ **ОТПРАВЛЕНО** 2026-07-22 09:31 UTC | `hello@theaidigest.org` (адрес из футера theaidigest.org). Тред `19f892a2168b4bf4`. Текст = черновик B с дословными цитатами обеих строк. |
...
| 2,3,5,6,7,8 | Nat Eliason, Jeez, Profiterole, Todasco, nof1, eltociear | ⏸ не отправлено | Ждут отдельного решения. |
